...
class Repesentante extends FormRequest
{
  ...
  public function messages()
  {
    return [
      ...
      'nombre.min' => 'El nombre debe ser minimo de 3 numeros',
      'nombre.max' => 'El nombre debe ser maximo de 30 numeros',
      ...
      'apellido.min' => 'El apellido de ser minimo de 3 numeros',
      'apellido.max' => 'El apellido de ser maximo de 30 numeros',
