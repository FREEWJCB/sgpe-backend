...
Route::group([
    ...
    Route::post('/verificarcorreo', [RecuperaContrasenaController::class, 'verificarCorreo'])->name('verificar');
    Route::post('/recuperarcontrasena/{user}', [RecuperaContrasenaController::class, 'recuperarContrasena'])->name('verificar');
});
